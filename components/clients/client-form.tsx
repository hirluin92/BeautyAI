...
export default function ClientForm({ 
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.full_name.trim()) {
      errors.full_name = 'Il nome è obbligatorio'
    }
    ...
    <div className="bg-white rounded-lg shadow">
      ...
      <form onSubmit={handleSubmit} className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2 border ${fieldErrors.full_name ? 'border-red-500' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500`}
              placeholder="Maria Rossi"
            />
            {fieldErrors.full_name && (
              <p className="mt-1 text-sm text-red-600" role="alert">{fieldErrors.full_name}</p>
            )}
          </div>
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2 border ${fieldErrors.phone ? 'border-red-500' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500`}
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2 border ${fieldErrors.email ? 'border-red-500' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500`}
        ...
        <div>
          ...
          {/* Current Tags */}
          <div className="flex flex-wrap gap-2 mb-3" id="tags" data-testid="tags">
